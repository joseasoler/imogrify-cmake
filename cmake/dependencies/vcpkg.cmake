...
if (VCPKG_TARGET_TRIPLET)
	...
	if (IMOGRIFY_BUILD_DEPENDENCY_BENCHMARKS OR IMOGRIFY_BUILD_IMOGRIFY_BENCHMARKS)
		list(APPEND VCPKG_MANIFEST_FEATURES "benchmark-imogrify")
	endif ()
	if (IMOGRIFY_BUILD_DEPENDENCY_BENCHMARKS)
		list(APPEND VCPKG_MANIFEST_FEATURES "benchmark-dependencies")
	endif ()
